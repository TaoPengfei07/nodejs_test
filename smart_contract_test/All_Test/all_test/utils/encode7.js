const AbiCoder = require('../../TestPekka/utils/abi-coder');
const compile = require('../compile7')
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            if (funABI.name === "constructor" || funABI.type === "constructor" || functionName === "constructor") {
                Params.data = compile.contractByteCode[contractName+"ContractByteCode"] + paramsEncode;
            } else {
                Params.data = compile.methodBytecode[contractName+'MethodBytecode'][functionName] + paramsEncode;
            }
            resolve(Params)
        } catch (e) {
            reject(e)
