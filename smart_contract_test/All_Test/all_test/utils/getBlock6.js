...
const czr = new Czr()
const decode = require('../../TestFactoryModel/utils/decode')
        ...
        czr.request.call({
            ...
            .then(ret => {
                if (ret.code === 0) {
                    ...
                    console.log('getBlock6 request failed =>', ret);
                    reject(ret)
                }
            })
    })
...
async function getGas(hash){
    let gasPrice = await getBlock6(hash)
